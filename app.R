  ...
  tabsetPanel(
              ...
              sidebarLayout(
                ...
                tabPanel("Other informations", fluid = TRUE,
                         ...
                         "The SNP is said snp id at least one sample have a different allele within a population",br(),
                         "When we compare alleles present in both population, they can have same allele content (same ref or alt or same combination of multiple alleles) then we declare them \"same\" ",br(),
